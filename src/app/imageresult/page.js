...
const ImageResult = () => {
  ...
  return (
    <div className="overflow-x-none ">
      ...
      <div class="flex flex-row items-stretch border-t border-t-gray-200 box-border  h-[673.6px] overflow-x-none relative bg-white lg:flex-row md:flex-col ">
        <div className="flex flex-col items-center bg-[#1F2125] box-border h-full  w-[50%] md:w-[100%] sm:w-[100%] relative ">
          <div
          ...
          <div className="w-[80%] h-[70%] p-4 absolute top-32 ">
            {/* <div>
              <Image
          ...
          <div className="w-[232.1px] h-[32px] border-none   rounded-3xl bg-[#383D3D]  flex items-center text-[14px] text-white absolute  bottom-12 ">
